" =============================================================================
" Filename: autoload/lightline/colorscheme/Monosvkem.vim
" Author: elsuizo
" License: MIT License
" Last Change: 2020/08/30 23:00
" =============================================================================
let s:black = [ '#000000', '0' ]
let s:black2 = [ '#121212', '233' ]
let s:white = ['#ffffff', '0']
...
let s:p.normal.left = [ [ s:black, s:white ], [ s:gray4, s:black2 ] ]
...
let s:p.insert.left = [ [ s:black, s:white ], [ s:gray4, s:black2 ] ]
let s:p.replace.left = [ [ s:black, s:red ], [ s:gray4, s:black2 ] ]
let s:p.visual.left = [ [ s:black, s:red ], [ s:gray4, s:black2 ] ]
